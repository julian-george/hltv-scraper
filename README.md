...
3. Successful betting strategies won't be punished by betting websites.
   - I used Thunderpick, a crypto-currency based betting site, which I assume wouldn't have the resources to build a model of their own or keep track of successful bettors.
